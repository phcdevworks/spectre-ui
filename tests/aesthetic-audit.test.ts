...
const ASSERTED_TOKEN_PATHS = {
  ...
  'var(--sp-color-neutral-600)': ['colors', 'neutral', '600'],
  'var(--sp-color-neutral-700)': ['colors', 'neutral', '700'],
  'var(--sp-color-neutral-800)': ['colors', 'neutral', '800'],
  'var(--sp-color-neutral-900)': ['colors', 'neutral', '900'],
  'var(--sp-color-brand-400)': ['colors', 'brand', '400'],
  'var(--sp-color-neutral-100)': ['colors', 'neutral', '100'],
  'var(--sp-color-success-800)': ['colors', 'success', '800'],
  'var(--sp-color-success-100)': ['colors', 'success', '100'],
  'var(--sp-color-success-400)': ['colors', 'success', '400'],
  'var(--sp-color-warning-800)': ['colors', 'warning', '800'],
  'var(--sp-color-warning-100)': ['colors', 'warning', '100'],
  'var(--sp-color-warning-400)': ['colors', 'warning', '400'],
  'var(--sp-color-error-800)': ['colors', 'error', '800'],
  'var(--sp-color-error-100)': ['colors', 'error', '100'],
  'var(--sp-color-error-400)': ['colors', 'error', '400'],
  'var(--sp-color-info-800)': ['colors', 'info', '800'],
  'var(--sp-color-info-100)': ['colors', 'info', '100'],
  'var(--sp-color-info-400)': ['colors', 'info', '400'],
} as const;
...
const SEMANTIC_ROLE_ASSERTIONS: SemanticRoleAssertion[] = [
  ...
  { name: 'Testimonial Author Title', property: '--sp-component-testimonial-author-title', expected: 'var(--sp-color-neutral-600)', requiresContrast: true },
  { name: 'Testimonial Quote Mark', property: '--sp-component-testimonial-quote-mark', expected: 'var(--sp-color-neutral-600)' },
  ...
  { name: 'Pricing Card Price Description', property: '--sp-component-pricing-card-price-description', expected: 'var(--sp-color-neutral-600)', requiresContrast: true },
...
const SEMANTIC_ROLE_PAIR_RULES: SemanticRolePairRule[] = [
  ...
  },
  {
    ...
    allowedBackgrounds: ['var(--sp-badge-success-bg)', 'var(--sp-color-success-800)'],
    textProperty: '--sp-component-badge-success-text',
    allowedTexts: ['var(--sp-badge-success-text)', 'var(--sp-color-success-100)'],
  },
  {
    name: 'Badge Warning',
    backgroundProperty: '--sp-component-badge-warning-bg',
    allowedBackgrounds: ['var(--sp-badge-warning-bg)', 'var(--sp-color-warning-800)'],
    textProperty: '--sp-component-badge-warning-text',
    allowedTexts: ['var(--sp-badge-warning-text)', 'var(--sp-color-warning-100)'],
  },
  {
    name: 'Badge Danger',
    backgroundProperty: '--sp-component-badge-danger-bg',
    allowedBackgrounds: ['var(--sp-badge-danger-bg)', 'var(--sp-color-error-800)'],
    textProperty: '--sp-component-badge-danger-text',
    allowedTexts: ['var(--sp-badge-danger-text)', 'var(--sp-color-error-100)'],
  },
  {
    name: 'Badge Neutral',
    backgroundProperty: '--sp-component-badge-neutral-bg',
    allowedBackgrounds: ['var(--sp-badge-neutral-bg)', 'var(--sp-color-neutral-700)'],
    textProperty: '--sp-component-badge-neutral-text',
    allowedTexts: ['var(--sp-badge-neutral-text)', 'var(--sp-color-neutral-100)'],
  },
  {
    name: 'Badge Info',
    backgroundProperty: '--sp-component-badge-info-bg',
    allowedBackgrounds: ['var(--sp-badge-info-bg)', 'var(--sp-color-info-800)'],
    textProperty: '--sp-component-badge-info-text',
    allowedTexts: ['var(--sp-badge-info-text)', 'var(--sp-color-info-100)'],
  },
  {
  ...
  },
  {
    ...
    allowedBackgrounds: ['var(--sp-color-success-50)', 'var(--sp-color-neutral-800)'],
    textProperty: '--sp-component-iconbox-success-text',
    allowedTexts: ['var(--sp-icon-box-icon-success)', 'var(--sp-color-success-400)'],
  },
  {
    name: 'Icon Box Warning',
    backgroundProperty: '--sp-component-iconbox-warning-bg',
    allowedBackgrounds: ['var(--sp-color-warning-50)', 'var(--sp-color-neutral-800)'],
    textProperty: '--sp-component-iconbox-warning-text',
    allowedTexts: ['var(--sp-icon-box-icon-warning)', 'var(--sp-color-warning-400)'],
  },
  {
    name: 'Icon Box Danger',
    backgroundProperty: '--sp-component-iconbox-danger-bg',
    allowedBackgrounds: ['var(--sp-color-error-50)', 'var(--sp-color-neutral-800)'],
    textProperty: '--sp-component-iconbox-danger-text',
    allowedTexts: ['var(--sp-icon-box-icon-danger)', 'var(--sp-color-error-400)'],
  },
  {
    name: 'Icon Box Info',
    backgroundProperty: '--sp-component-iconbox-info-bg',
    allowedBackgrounds: ['var(--sp-color-info-50)', 'var(--sp-color-neutral-800)'],
    textProperty: '--sp-component-iconbox-info-text',
    allowedTexts: ['var(--sp-badge-info-text)', 'var(--sp-color-info-400)'],
  },
  {
    name: 'Icon Box Secondary',
    backgroundProperty: '--sp-component-iconbox-secondary-bg',
    allowedBackgrounds: ['var(--sp-button-secondary-bg)'],
    textProperty: '--sp-component-iconbox-secondary-text',
    allowedTexts: ['var(--sp-button-secondary-text)'],
    borderProperty: '--sp-component-iconbox-secondary-border',
    allowedBorders: ['var(--sp-button-secondary-border)'],
  },
  {
    name: 'Icon Box Accent',
    backgroundProperty: '--sp-component-iconbox-accent-bg',
    allowedBackgrounds: ['var(--sp-button-accent-bg)'],
    textProperty: '--sp-component-iconbox-accent-text',
    allowedTexts: ['var(--sp-button-accent-text)'],
  },
  {
    name: 'Testimonial',
